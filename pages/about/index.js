    ...
    <div className='h-full bg-primary/30 py-32 text-center xl:text-left '>
      ...
      <div className='container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6 '>
        ...
        <div className='flex-1 flex flex-col justify-center pl-14'>
          ...
          >
          Tóm lại, khi người dùng nhấp vào một mục trong danh sách, biến  thay đổi để chỉ trỏ tới mục đã chọn. 
          Sau đó, đoạn mã sẽ hiển thị các tiêu đề của các mục con trong mảng  của mục đã chọn.
          </motion.p>
          {/* counters */}
          <div 
        ...
        <motion.div 
          ...
          animate='show'
          exit='hidden' 
          className='flex flex-col w-full xl:max-w-[48%] h-[480px] pb-20'
        >
