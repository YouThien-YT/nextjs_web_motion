  ...
  return (
    <div className="bg-primary/60 h-full">
      ...
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10 ">
        <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto ">
          ...
          <motion.div 
            ...
            animate='show' 
            exit='hidden' 
            className=" z-10 hidden xl:flex pb-28 " 
          >
            <ProjectsBtn></ProjectsBtn>
          </motion.div>
        </div>
      ...
      <div className="w-[1200px] h-full absolute right-0 bottom-0">
        {/* xl:bg_img */}
        <div className={`bg-none xl:bg-[url(https://i.imgur.com/miiIfUM.png)] xl:bg-cover xl:bg-right xl:bg-no-repeat w-full h-full absolute mix-blend-color-dodge translate-z-0 `}>
        </div>
        {/* particles */}
